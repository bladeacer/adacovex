...
def main(argv: List[str]) -> int:
    ...
    ap.add_argument("--max-file-loc", type=int, default=4000)
    ap.add_argument("--max-file-pct", type=float, default=20.0)
    ap.add_argument("--max-fn-complexity", type=int, default=120)
    ap.add_argument("--max-file-complexity", type=int, default=600)
