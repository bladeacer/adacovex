...
PACKAGE_GUIDES: Dict[str, List[Tuple[str, str]]] = {
    ...
    "Adacovex.Prove": [
        ("Architecture -- toolchain resolution",
         "../contributing/architecture.md#gnatprove-toolchain-resolution-prove-subcommand"),
    ],
    "Adacovex.Cache": [
...
def render_index(packages: Dict[str, str]) -> str:
    ...
    # short; the full STE100 rules live in docs/contributing/ste100-technical-names.md.
