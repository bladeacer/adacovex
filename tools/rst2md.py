...
PACKAGE_GUIDES: Dict[str, List[Tuple[str, str]]] = {
    ...
    "Adacovex.Prove": [
        ("Architecture -- toolchain resolution",
         "../contributing/architecture-dependencies.md#gnatprove-toolchain-resolution-prove-subcommand"),
    ],
    "Adacovex.Cache": [
        ("Architecture -- result caching", "../contributing/architecture.md#result-caching"),
    ],
    "Adacovex.Diff": [
        ("VCS support", "../usage/vcs.md"),
    ],
    "Adacovex.VCS": [
        ("VCS support", "../usage/vcs.md"),
    ],
    ...
    "Adacovex.Renderers.HTML": [
        ("Web dashboard", "../usage/dashboard.md"),
    ],
...
def render_index(packages: Dict[str, str]) -> str:
    # The index is regenerated by `make doc`, so the reader guidance lives
    # here rather than in a hand-edited file.  Keep it British English and
    # short; the full STE100 rules live in docs/contributing/ste100/index.md.
    lines = ["# adacovex API Reference", "", "## How to read this reference", ""]
    lines.extend(
        [
