...
`-- tests/
    ...
    `-- test_runner.adb                       -- Test suite entry point (989 tests)
```
<!-- agents-tree:end -->
...
| `test` | Build + run the 989-test native suite |
...
|-------|---------|-------------|
| Unit tests | `make test` | 989/989 passing |
...
Native zero-dependency suite (`src/tests/`, 989 tests across 14 categories).
