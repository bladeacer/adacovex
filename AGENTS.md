...
- 1066/1066 native tests passing
...
`-- tests/
    ...
    `-- test_runner.adb                       -- Test suite entry point (1066 tests)
```
<!-- agents-tree:end -->
...
| `test` | Build + run the 1066-test native suite |
...
Native zero-dependency suite (`src/tests/`, 1066 tests across 14 categories).
