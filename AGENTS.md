...
`-- tests/
    ...
    |-- adacovex_sbom_tests.ads/.adb          -- SBOM / manifest graph tests (200)
    ...
    `-- test_runner.adb                       -- Test suite entry point (968 tests)
```
<!-- agents-tree:end -->
...
| `test` | Build + run the 968-test native suite |
...
Native zero-dependency suite (`src/tests/`, 968 tests across 14 categories).
