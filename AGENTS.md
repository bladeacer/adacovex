...
`-- tests/
    ...
    |-- adacovex_config_tests.ads/.adb        -- CLI config tests (110)
    ...
    |-- adacovex_renderer_tests.ads/.adb      -- HTML/Markdown renderer tests (26)
    ...
    `-- test_runner.adb                       -- Test suite entry point (634 tests)
```
<!-- agents-tree:end -->
...
| `test` | Build + run the 634-test native suite |
...
Native zero-dependency suite (`src/tests/`, 634 tests across 12 categories).
