...
`-- tests/
    ...
    `-- test_runner.adb                       -- Test suite entry point (850 tests)
```
<!-- agents-tree:end -->
...
| `test` | Build + run the 850-test native suite |
...
Native zero-dependency suite (`src/tests/`, 850 tests across 14 categories).
