...
- 1167/1167 native tests passing
...
`-- tests/
    ...
    |-- adacovex_server_tests.ads/.adb        -- Server routing tests (35)
    ...
    `-- test_runner.adb                       -- Test suite entry point (1167 tests)
```
<!-- agents-tree:end -->
...
| `test` | Build + run the 1167-test native suite |
...
Native zero-dependency suite (`src/tests/`, 1167 tests across 16 categories).
