...
`-- tests/
    ...
    `-- test_runner.adb                       -- Test suite entry point (601 tests)
```
<!-- agents-tree:end -->
...
| `test` | Build + run the 601-test native suite |
...
Native zero-dependency suite (`src/tests/`, 601 tests across 12 categories).
