...
`-- tests/
    ...
    `-- test_runner.adb                       -- Test suite entry point (663 tests)
```
<!-- agents-tree:end -->
...
| `test` | Build + run the 663-test native suite |
...
Native zero-dependency suite (`src/tests/`, 663 tests across 12 categories).
