...
- LLR-SCAN-01: Scan_Project shall walk directories recursively. It shall skip .git and obj [HLR-SCAN]
- LLR-SCAN-02: Scan_Ads_File shall extract procedure, function, and generic declarations [HLR-SCAN]
- LLR-SCAN-03: Scan_Ads_File shall find -- HLR-XXXX tags in source [HLR-SCAN]
- LLR-SCAN-04: Scan_Ads_File shall find @param, @return, @field, @formal docstring tags [HLR-SCAN]
...
- LLR-DAL-01: Assess_DAL_C shall make sure that all HLRs are traced in source [HLR-COMPLIANCE] [HLR-DAL-C]
- LLR-DAL-02: Assess_DAL_C shall find orphan tags that do not match any HLR [HLR-COMPLIANCE] [HLR-DAL-C]
- LLR-DAL-03: Assess_DAL_C shall make sure that test results show zero failures [HLR-COMPLIANCE] [HLR-DAL-C]
- LLR-DAL-04: Assess_DAL_C shall make sure that SPARK level is >= Bronze [HLR-COMPLIANCE] [HLR-DAL-C]
