...
Vendored dependencies then participate in the proof without their sources being touched. See [Proving and writing proofs](../contributing/proving.md#proof-patches-proving-vendored-dependencies) for how to write them, and [Architecture -- Proof patches](../contributing/architecture.md#proof-patches-spark-contracts-over-vendored-dependencies) for the design.
...
adacovex --target=. --require-spark=Platinum --require-docstrings=100 \
         --require-tests=1181 --require-proof=100
```
...
[Proving and writing proofs -- proof patches](../contributing/proving.md#proof-patches-proving-vendored-dependencies).
