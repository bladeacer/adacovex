...
adacovex uses a native zero-dependency test framework (`Adacovex.Test_Support`) with 1518 tests across 22 categories. No external test framework (AUnit, and more) is required. Test results are written to `docs/test_result.md` in a parseable Markdown table format.
