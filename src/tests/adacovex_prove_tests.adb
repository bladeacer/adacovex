...
package body Adacovex_Prove_Tests is
   ...
   begin
      ...
      declare
         S : Proof_Summary;
      begin
         S := (Runtime_Checks => 10, Runtime_Proved => 10,
               Assertions => 5, Assert_Proved => 5, others => <>);
         R.Check
      ...
      begin
         S := (Runtime_Checks => 10, Runtime_Proved => 10,
               Assertions => 5, Assert_Proved => 3, others => <>);
         R.Check
           (Adacovex.Parsers.GNATprove.Determine_SPARK_Level (S) = Silver,
      ...
      declare
         S : Proof_Summary;
      begin
         S := (Flow_Checks => 7, Flow_Proved => 7,
               Runtime_Checks => 10, Runtime_Proved => 5, others => <>);
         R.Check
      ...
      begin
         ...
         R.Check
           (Summary.Unproved = 3,
            "Parse_Prove_Out (Silver): Unproved = 3");
         R.Check
