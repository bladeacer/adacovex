...
package body Adacovex.Server.HTTP is
   ...
   procedure Handle_Request (Channel : Socket_Type; State : Server_State);
   ...
   procedure Handle_Request (Channel : Socket_Type; State : Server_State) is
   ...
   begin
      ...
      if Path = "/" then
         ...
         Send_Response
           (Channel, "404 Not Found", "text/plain", "Not Found: " & Path);
      end if;
   end Handle_Request;
